...
{
    [Activity(Label = "IndigoColorActivity")]
    public class IndigoColorActivity : Activity
    {
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            nextImage.Click += (sender, e) =>
            {
                try
                {
                    var nextActivity = new Intent(this, typeof(BlueColorActivity));
            ...
            colorView.SetBackgroundColor(Color.Indigo);
