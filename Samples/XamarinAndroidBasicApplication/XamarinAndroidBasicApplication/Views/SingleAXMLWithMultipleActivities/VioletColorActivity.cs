...
{
    [Activity(Label = "VioletColorActivity")]
    public class VioletColorActivity : Activity
    {
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            nextImage.Click += (sender, e) =>
            {
                try
                {
                    var nextActivity = new Intent(this, typeof(IndigoColorActivity));
            ...
            colorView.SetBackgroundColor(Color.Violet);
