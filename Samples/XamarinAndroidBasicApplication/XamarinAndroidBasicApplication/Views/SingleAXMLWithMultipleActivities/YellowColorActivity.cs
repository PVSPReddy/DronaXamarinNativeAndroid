...
{
    [Activity(Label = "YellowColorActivity")]
    public class YellowColorActivity : Activity
    {
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            nextImage.Click += (sender, e) =>
            {
                try
                {
                    var nextActivity = new Intent(this, typeof(OrangeColorActivity));
