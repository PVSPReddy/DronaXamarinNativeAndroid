...
{
    [Activity(Label = "BlueColorActivity")]
    public class BlueColorActivity : Activity
    {
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            nextImage.Click += (sender, e) =>
            {
                try
                {
                    var nextActivity = new Intent(this, typeof(GreenColorActivity));
